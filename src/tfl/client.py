...
class Client:
    ...
    def get_stop_points_by_id(self, stop_point_id):
    ...
    def get_arrivals_by_stop_point(self, stop_point_id, line_id=None): 
        response = self.client.send_request(endpoints['stopPointArrivals'].format(stop_point_id), {'lineIds': line_id is True})
